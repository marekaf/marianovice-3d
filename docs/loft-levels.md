...
Heights are metres above the ground-floor finished floor, not terrain levels.

| Element | Level | Source |
| --- | ---: | --- |
| Ground-floor finished floor | 0.000 | Section 301 A–A′ |
| Structural ceiling underside | 2.520 | Section 301 A–A′ |
...
The living-room ST03 schedule totals 292 mm normal to the roof: 25 mm
bioboard, 200 mm PIR, 40 mm counter-battens, 18 mm deck, 8 mm separation layer
and 1 mm metal. Exposed rafters below the board are additional members.
The cathedral lining uses that nominal depth and the exterior ridge axis.

For the loft ST01 lining, detail 405 includes a 37.5 mm service gap behind
...
spacing still require as-built confirmation.

The inaccessible western-wing floor build-up meets the shallow roof underside.
Its top tapers over the outer 254 mm, from approximately +2.898 at the western
edge to the unchanged +2.920 floor level. The bottom stays at +2.770, and the
usable rooms, stair opening and access hatch retain their dimensions. This
removes a model intersection; it does not specify an approved construction detail.
