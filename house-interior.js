...
const HOUSE_INTERIOR = {
  ...
  furniture: [
    ...
    { kind: 'bed', room: '1.04', label: 'postel hosté 1800', x0: 1.30, z0: 16.75, x1: 3.10, z1: 18.75, h: 0.75, head: 'S' },
    { kind: 'slab', room: '1.04', label: 'noční stolek hosté W', mat: 'wood', x0: 0.90, z0: 18.45, x1: 1.30, z1: 18.75, y0: 0.15, h: 0.35, front: 'N' },
    { kind: 'slab', room: '1.04', label: 'noční stolek hosté E', mat: 'wood', x0: 3.10, z0: 18.45, x1: 3.50, z1: 18.75, y0: 0.15, h: 0.35, front: 'N' },
