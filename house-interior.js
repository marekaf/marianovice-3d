...
const HOUSE_INTERIOR = {
  ...
  furniture: [
    ...
    { kind: 'bed', room: '1.12', label: 'postel 2300×2090', x0: 6.47, z0: 0.45, x1: 8.77, z1: 2.54, h: 0.45 },
    { kind: 'slab', room: '1.12', label: 'noční stolek W', mat: 'wood', x0: 5.87, z0: 0.45, x1: 6.47, z1: 0.85, y0: 0.15, h: 0.35 },
    { kind: 'slab', room: '1.12', label: 'noční stolek E', mat: 'wood', x0: 8.77, z0: 0.45, x1: 9.37, z1: 0.85, y0: 0.15, h: 0.35 },
    ...
    { kind: 'cab', room: '1.11', label: 'šatna skříň W', x0: 3.40, z0: 0.45, x1: 4.00, z1: 2.15, h: 2.50, front: 'E', modules: [0.85, 0.85], tags: ['d', 'd'] },
    { kind: 'cab', room: '1.11', label: 'šatna skříň E', x0: 5.10, z0: 0.45, x1: 5.70, z1: 2.15, h: 2.50, front: 'W', modules: [0.85, 0.85], tags: ['d', 'd'] },
