const GradingReport = (() => {
  ...
  function render({garden,terrain,site,survey,data}) {
    ...
    const zoneMap=mapSVG.replace('</svg>',zoneBoundaries+fenceMarks+presentation.svgTerrainMarks(garden,px,pz,quantities)+dimensionMarks+presentation.svgLabels(quantities.zones,px,pz)+presentation.svgLevelMarks(quantities.levelMarks,px,pz)+'</svg>');
