const GradingZones = (() => {
  ...
  function create(garden) {
    ...
    if(sauna&&shelter) {
      ...
      dimensions.push({id:'saunaFacility',name:'Sauna se zádveřím a krytou vířivkou',value:`${(x1-x0).toFixed(2)} × ${(z1-z0).toFixed(2)} m`,from:[x0,z0],to:[x1,z0],displayOffset:[0,-1]});
      dimensions.push({id:'saunaFacilityDepth',name:'Sauna s vířivkou – hloubka',value:(z1-z0).toFixed(2)+' m',from:[x0,z0],to:[x0,z1],displayOffset:[-.6,0],table:false});
    }
