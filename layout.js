...
const GARDEN = {
  ...
  elements: [
    ...
    },
    {
      id: "orchardMeadow",
      name: "Sad s loukou",
      meta: {plant: "meadow", selectedFlowers: "meadow-daisies"},
      parts: [
    ...
    {
      id: "specimenMaple",
      name: "Solitérní javor",
      meta: {species: "Acer × freemanii"},
      parts: [{kind: "circle", cx: 32.3, cy: 14, r: .35, canopyRadius: 2, fill: "#618447"}]
    },
    {
      id: "orchard",
      name: "Ovocné stromy",
